...
public class Productdetail extends Activity implements OnClickListener {
	...
	private String importData(int lastinsertedid)
	{
		...
		try
		{
			...
			// HttpPost("http://192.168.1.80/FYP/database.php");
		...
		// paring data
		// int ct_id;
		String category = "", productname = "", shopname = "", brand = "", address = "";// ,postal
																						// =
																						// "";
	...
	void downloadFile(String filename)
	{
		...
		try
		{
			myFileUrl = new URL("http://10.0.2.2/FYP/uploads/" + filename + ".jpg");
	...
	public void onClick(View v)
	{
		...
		else if (v == lblshop || v == lbladdress)
		{
			...
			Intent shopIntent = new Intent(Productdetail.this, ShopPage.class);
	...
	private void updateComments(String type, int id, int numberComments)
	{
		...
		try
		{
			...
			httppost = new HttpPost("http://10.0.2.2/insertcomments.php");
			// httppost = new
